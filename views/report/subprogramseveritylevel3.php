            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading"><h5><i class="glyphicon glyphicon-user"></i> รายงานอุบัติการ แยกตามอุบัติการณ์ แยกระดับความรุนแรง</h5></div>
                        <div class="panel-body">
                            <div>
                                <?php
                                echo Highcharts::widget([
                                    'options' => [
                                        'title' => ['text' => 'อุบัติการณ์'],
                                        'xAxis' => [
                                            'categories' => $incident_name
                                        ],
                                        'yAxis' => [
