            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading"><h5><i class="glyphicon glyphicon-user"></i> รายงานอุบัติการ แยกตามกระบวนการ แยกระดับความรุนแรง</h5></div>
                        <div class="panel-body">
                            <div>
                                <?php
                                echo Highcharts::widget([
                                    'options' => [
                                        'title' => ['text' => 'กระบวนการ'],
                                        'xAxis' => [
                                            'categories' => $pro_risk_sub_detail_name
                                        ],
                                        'yAxis' => [
                                ...
                                echo GridView::widget([
                                    ...
                                    'columns' => [
                                        ...
                                        [
                                            ...
                                            'format' => 'raw',
                                            'value' => function($model)use($pro_risk_sub_detail_name) {
                                                return Html::a(Html::encode($model['pro_risk_sub_detail_name']), [
                                                    'report/subprogramseveritylevel3/',
                                                    'pro_risk_sub_detail_id' => $model['pro_risk_sub_detail_id'],
                                                ]);
                                            }
                                        ],
                                        [
