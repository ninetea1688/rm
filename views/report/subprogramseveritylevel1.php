            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading"><h5><i class="glyphicon glyphicon-user"></i> รายงานอุบัติการ แยกตามโปรแกรมความเสี่ยงย่อย แยกระดับความรุนแรง</h5></div>
                        <div class="panel-body">
                            <div>
                                <?php
                                echo Highcharts::widget([
                                    'options' => [
                                        'title' => ['text' => 'โปรแกรมความเสี่ยงย่อย'],
                                        'xAxis' => [
                                            'categories' => $pro_risk_detail_name
                                        ],
                                        'yAxis' => [
                            ...
                            <div>
                                ...
                                echo GridView::widget([
                                    ...
                                    'columns' => [
                                        ...
                                        [
                                            'label' => 'โปรแกรมความเสี่ยงย่อย',
                                            'attribute' => 'pro_risk_detail_name',
                                            'format' => 'raw',
                                            'value' => function($model)use($pro_risk_detail_name) {
                                                return Html::a(Html::encode($model['pro_risk_detail_name']), [
                                                    'report/subprogramseveritylevel2/',
                                                    'pro_risk_detail_id' => $model['pro_risk_detail_id'],
                                                ]);
                                            }
                                        ],
                                        [
