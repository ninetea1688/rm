        ...
        <div class="panel-body">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-info">
                            <div class="panel-heading"><h5><i class="glyphicon glyphicon-tasks"></i> ส่วนรับเรื่องความเสี่ยง โดย RMC หน่วยงาน, หัวหน้างาน
                                </h5></div>
                            <div class="panel-body">
                                <div class="row">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    <?= Html::submitButton($model->isNewRecord ? 'บันทึกข้อมูล' : 'รับเรื่องความเสี่ยง', ['class' => $model->isNewRecord ? 'btn btn-success btn-lg btn-block glyphicon glyphicon-floppy-save' : 'btn btn-info btn-lg btn-block glyphicon glyphicon-floppy-save']) ?>
                </div>
                </center>
            </div>
            <?php ActiveForm::end(); ?>
