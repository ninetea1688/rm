            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading"><h5><i class="glyphicon glyphicon-tasks"></i> ส่วนรับเรื่องความเสี่ยง
                                โดย RMC หน่วยงาน, หัวหน้างาน
                            </h5></div>
                        <div class="panel-body">
                            <div class="row">

                                <div class="col-md-3">
                                    <?= $form->field($model, 'date_edit')->textInput(array('value' => date("Y-m-d"), 'readOnly' => true)) ?>
                                </div>
                                <div class="col-md-3">
                    ...
                    <div class="panel panel-warning">
                        <div class="panel-heading"><h5><i class="glyphicon glyphicon-floppy-saved"></i>
                                ส่วนทบทวนความเสี่ยง โดย ศูนย์บริหารความเสี่ยง
                            </h5></div>
                        <div class="panel-body">
                            <div class="row">

                                <div class="col-md-4">
                                    <?= $form->field($model, 'review_date')->textInput(array('value' => date("Y-m-d"), 'readOnly' => true)) ?>
                                </div>
                                <div class="col-md-4">
                    ...
                    <div class="row">
                        <center>
                            <div class="form-group">
                                <?= Html::submitButton($model->isNewRecord ? 'บันทึกข้อมูล' : 'รับการทบทวนความเสี่ยง', ['class' => $model->isNewRecord ? 'btn btn-success btn-lg btn-block glyphicon glyphicon-floppy-save' : 'btn btn-info btn-lg btn-block glyphicon glyphicon-floppy-save']) ?>
                            </div>
                        </center>
                    </div>
                    <?php ActiveForm::end(); ?>
